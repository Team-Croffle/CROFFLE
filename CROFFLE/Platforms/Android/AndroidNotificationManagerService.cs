...
{
    internal class AndroidNotificationManagerService : INotificationManagerService
    {
        ...
        public void Show(string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(Platform.AppContext, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(Platform.AppContext.Resources, Resource.Drawable.croffle_big))
                .SetSmallIcon(Resource.Drawable.croffle2);
